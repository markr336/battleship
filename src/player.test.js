...
it('Player test', () => {
    ...
    class Gameboard {
        ...
        placeShip(ship, verticalStart, horizontalStart, verticalEnd, horizontalEnd) {
    ...
    const player1 = new Player('Tony', 'Real')
    const patrolBoat = new Ship('Patrol Boat', 2)
    expect(player1.gameboard.placeShip(patrolBoat, 0, 0, 0, 1)).toBe('Patrol Boat placed')
})